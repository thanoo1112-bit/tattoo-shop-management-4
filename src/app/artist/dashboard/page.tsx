...
import AppointmentRow from "@/app/admin/AppointmentRow"; // Reusing component
...
export default async function ArtistDashboard() {
  ...
  // Since layout protects this route, we know user is an artist.
  ...
  // Fetch Appointments only for this artist
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-gothic tracking-widest uppercase">
            หน้าจัดการคิว (ARTIST DASHBOARD)
          </h1>
      ...
      <div className="raw-panel p-0 overflow-hidden border border-border-dark">
        <div className="p-6 border-b border-border-dark flex justify-between items-center">
          <h2 className="text-lg md:text-xl font-gothic tracking-widest uppercase">
            คำขอจองคิวของคุณ (Your Requests)
          </h2>
        </div>
